    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                isEditState = getAdapter().getIsEditState();
                mDownX = (int) ev.getX();
                mDownY = (int) ev.getY();
                // 获取当前触摸位置对应的条目索引
                ...
                mRawOffsetX = (int) (ev.getRawX() - mDownX);   //listview.getLeft;
                mRawOffsetY = (int) (ev.getRawY() - mDownY);   //listview.getTop
    ...
    private boolean startDrag() {
        ...
        aAnim.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                if (isEditState && mToPosition == mDragPosition) {
